...
import InternshipCompaniesRow from "../../components/Workspace/InternshipCompaniesRow";
import {
    AccessInfo,
    DataListInput,
    FormInput,
...
const InternshipCompanies = () => {
  ...
  return (
    <div>
        ...
        >
        <AccessInfo style={{ margin: "0 20px 0 0" }}>Internship Companies</AccessInfo>
        {addDues ? null : (
            <GlobalButton
        ...
        {loading ? (
            ...
            <ul class="responsive-table">
                <li class="table-header">
                    ...
                    <div class="col col-d-4">Contact Person</div>
                </li>
                    
                {dueData.map((data, index) => (
                    <InternshipCompaniesRow data={data} key={index} fetch={fetch} />
                ))}
            </ul>
            </>
        )}
