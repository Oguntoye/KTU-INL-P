...
import InternshipOrganization from "../../components/Workspace/InternshipOrganization";
import {
    AccessInfo,
    DataListInput,
    FormInput,
...
const OrganizationsAI = () => {
    ...
    const fetch = async () => {
        ...
        setDueData([
            {
                id:"1",
                companyname:"Glydetek Group",
                category:"ICT",
                region:"Greater Accra",
                contactperson:"Mr. Adade",
                emailaddress:"hello@glydetek.com",
                contactphonenumber:"0537764995",
                Status:"Active",
            },
            {
                id:"2",
                companyname:"SOLT Group",
                category:"Automobiles",
                region:"Kumasi",
                contactperson:"Mr. Jones",
                emailaddress:"jones@solt.com",
                contactphonenumber:"0537764995",
                Status:"Active",
            },
        ])
  ...
  return (
    <div>
        ...
        >
        <AccessInfo style={{ margin: "0 20px 0 0" }}>Organizations</AccessInfo>
        {/* {addDues ? null : (
            <GlobalButton
        ...
        {loading ? (
            ...
            <ul class="responsive-table">
                <li class="table-header">
                    ...
                    <div class="col col-d-2">Category</div>
                    <div class="col col-d-3">Region</div>
                    <div class="col col-d-4">Status</div>
                </li>
                    
                {dueData.map((data, index) => (
                    <InternshipOrganization data={data} key={index} fetch={fetch} />
                ))}
            </ul>
            </>
        )}
...
export default OrganizationsAI;
